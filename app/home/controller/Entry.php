...
class Entry {
	public function index() {
		...
		$config = [
			...
			"encodingaeskey" => "1BclPRTIQwBXRZPlbl8XGHzaQpxDLT0emW5IIQfTkaC",
			//公众号身份标识
			"appid"          => "wxc47243ed572e273d",
			//公众平台API(参考文档API 接口部分)的权限获取所需密钥Key
			"appsecret"      => "1c72ad236f72c70e347343653410934b",
		...
		\WeChat::instance( 'message' )->text( 'aa' );
	}
}